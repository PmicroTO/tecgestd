...
CREATE TABLE listapopular.lista (
	...
	cpfcli numeric(11) NOT NULL,
	CONSTRAINT lista_pk PRIMARY KEY (codlista, cpfcli),
	CONSTRAINT lista_fk FOREIGN KEY (cpfcli) REFERENCES listapopular.cliente(cpfcli)
);
...
CREATE TABLE listapopular.entrega (
	...
	CONSTRAINT entrega_fk FOREIGN KEY (codlista,cpfcli) REFERENCES listapopular.lista(codlista,cpfcli)
);
...
CREATE TABLE listapopular.listaprod (
	...
	quantia int4 NOT NULL,
	cpfcli numeric(11) NOT NULL,
	CONSTRAINT listaprod_pk PRIMARY KEY (codlista, cnpjmer, codprod, cpfcli),
	CONSTRAINT listaprod_fk FOREIGN KEY (codlista,cpfcli) REFERENCES listapopular.lista(codlista,cpfcli),
...
CREATE TABLE listapopular.listaprom (
	...
	quantia int4 NOT NULL,
	cpfcli numeric(11) NOT NULL,
	CONSTRAINT listaprom_pk PRIMARY KEY (codlista, codprom, cnpjmer, cpfcli),
	CONSTRAINT listaprom_fk FOREIGN KEY (cnpjmer,codprom) REFERENCES listapopular.promocao(cnpjmer,codprom),
	CONSTRAINT listaprom_fk_1 FOREIGN KEY (codlista,cpfcli) REFERENCES listapopular.lista(codlista,cpfcli)
);
...
CREATE TABLE listapopular.contrato (
	...
	CONSTRAINT contrato_pk PRIMARY KEY (cnpjmer, codentrega),
